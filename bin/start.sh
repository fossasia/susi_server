...
cmdline="$cmdline -server -classpath $CLASSPATH -Dlog4j.configurationFile=./conf/log.properties org.loklak.LoklakServer >> data/stdout.log 2>&1 & echo \$! > data/loklak.pid &";
