...
To install Susi with Docker on Google Cloud please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_gcloud>`.

How do I install Susi with Docker on AWS?
----------------------------------

To install Susi with Docker on AWS please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_aws>`.

How do I install Susi with Docker on Bluemix ?
----------------------------------

To install Susi with Docker on Bluemix please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_bluemix>`.

How do I install Susi with Docker on Digital Ocean ?
----------------------------------

To install Susi with Docker on Digital Ocean please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_digitalocean>`.

How do I deploy Susi with Heroku?
---------------------------------

You can easily deploy to Heroku by clicking the Deploy to Heroku button above. To install Susi using Heroku Toolbelt, please refer to the :doc:`Susi Heroku installation readme <installation/installation_heroku>`.

How do I deploy Susi with cloud9?
---------------------------------

To install Susi with cloud9 please refer to the :doc:`Susi cloud9 installation readme <installation/installation_cloud9>`.

How do I setup Susi on Eclipse?
-------------------------------

To install Susi on Eclipes, please refer to the :doc:`Susi Eclipse
...
The Susi skill language is described in the :doc:`Skill Development
