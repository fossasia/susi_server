...
To install Susi AI with Docker on Google Cloud please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_gcloud>`.

How do I install Susi AI with Docker on AWS?
----------------------------------

To install Susi AI with Docker on AWS please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_aws>`.

How do I install Susi AI with Docker on Bluemix ?
----------------------------------

To install Susi AI with Docker on Bluemix please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_bluemix>`.

How do I install Susi AI with Docker on Digital Ocean ?
----------------------------------

To install Susi AI with Docker on Digital Ocean please refer to the :doc:`Susi Docker installation readme <installation/installation_docker_digitalocean>`.

How do I deploy Susi AI with Heroku?
---------------------------------

You can easily deploy to Heroku by clicking the Deploy to Heroku button above. To install Susi AI using Heroku Toolbelt, please refer to the :doc:`Susi Heroku installation readme <installation/installation_heroku>`.

How do I deploy Susi AI with cloud9?
---------------------------------

To install Susi AI with cloud9 please refer to the :doc:`Susi cloud9 installation readme <installation/installation_cloud9>`.

How do I setup Susi AI on Eclipse?
-------------------------------

To install Susi AI on Eclipes, please refer to the :doc:`Susi Eclipse
readme <installation/eclipseSetup>`.
...
The Susi AI skill language is described in the :doc:`Skill Development
Tutorial <skills/susi_skill_development_tutorial>`.
