...
import org.loklak.api.access.AccessServlet;
import org.loklak.api.access.AuthorizationDemoService;
import org.loklak.api.access.LoginService;
import org.loklak.api.access.PasswordRecoveryService;
import org.loklak.api.access.PasswordResetService;
import org.loklak.api.access.PublicKeyRegistrationService;
import org.loklak.api.access.SignUpService;
import org.loklak.api.access.UserAccountPermissions;
import org.loklak.api.access.UserManagementService;
...
import org.loklak.api.susi.RSSReaderService;
import org.loklak.api.susi.StatusService;
import org.loklak.api.susi.SusiService;
import org.loklak.api.susi.UnansweredServlet;
...
public class SusiServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Log.getLog().info(String.valueOf(httpPort));
        ...
        Log.getLog().info(String.valueOf(httpsPort));
    ...
    private static void setServerHandler(File dataFile){
        ...
        // access api
        servletHandler.addServlet(AccessServlet.class, "/access/access.json");
        servletHandler.addServlet(AccessServlet.class, "/access/access.html");
        servletHandler.addServlet(AccessServlet.class, "/access/access.txt");
        ...
        inetAccessHandler.setHandler(securityHandler);
        
        SusiServer.server.setHandler(inetAccessHandler);
    }
