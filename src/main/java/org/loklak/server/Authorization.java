...
public class Authorization {
    ...
    public boolean isAdmin() {
        return this.json.has("admin") && this.json.getBoolean("admin");
    }
    ...
    private void setPermission(String servletCanonicalName, String key, JSONObject value){
    ...
    private void setPermission(String servletCanonicalName, String key, String value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, int value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, long value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, double value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, Object value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, boolean value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, Map<?, ?> value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
    ...
    private void setPermission(String servletCanonicalName, String key, Collection<?> value){
        if(!permissions.has(servletCanonicalName)) permissions.put(servletCanonicalName, new JSONObject());
        permissions.getJSONObject(servletCanonicalName).put(key, value);
    }
