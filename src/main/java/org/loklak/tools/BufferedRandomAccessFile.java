...
public class BufferedRandomAccessFile extends RandomAccessFile {
     ...
     * @throws IOException
     */
    private BufferedRandomAccessFile(String filename, String mode, int bufsize) throws IOException {
        super(filename, mode);
        invalidate();
        BUF_SIZE = bufsize;
    ...
    private BufferedRandomAccessFile(File file, String mode, int bufsize) throws IOException {
     ...
     * @throws IOException
     */
    protected synchronized IndexedLine readIndexedLine() throws IOException {
    ...
    public static class Test extends TestCase {
        ...
        public void testSimultanousWriteAndRead() throws IOException {
            ...
            for (String testLine : this.testLines) {
                long pos = braf.getFilePointer();
                braf.appendLine(UTF8.getBytes(testLine));
                braf.seekPrivate(pos);
                byte[] b = braf.getNextLine();
                if (!Objects.equals(ASCII.String(b), testLine)) System.out.println(ASCII.String(b) + " != " + testLine);
                assertTrue(Objects.equals(ASCII.String(b), testLine));
            }
            braf.close();
        }
