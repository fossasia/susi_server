...
public final class ByteBuffer extends OutputStream {
    ...
    private void write(final char b) {
        write((byte) b);
    }
    ...
    private ByteBuffer append(final byte[] bb) {
        write(bb, 0, bb.length);
        return this;
    }
    ...
    private byte[] getBytes(final int start, final int len) {
    ...
    private static boolean equals(final byte[] buffer, final byte[] pattern) {
