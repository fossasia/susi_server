...
public class DAO {
    ...
    public  static File html_dir;
    private static File external_data, assets, dictionaries;
    private static Settings public_settings;
    private static Settings private_settings;
    ...
    public static final Map<String, Accounting> accounting_temporary = new HashMap<>();
