...
public class GenericScraper extends HttpServlet {
     ...
     */
    private void printJSON(HttpServletResponse response, JSONObject genericScraperData) throws ServletException, IOException {
     ...
     */
    private JSONObject articleAPI(String url, JSONObject genericScraperData) throws MalformedURLException{
