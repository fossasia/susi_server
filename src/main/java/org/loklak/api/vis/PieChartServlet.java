...
public class PieChartServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws  IOException {
		...
		legendBit = "".equals(legendBitString) || "false".equals(legendBitString);

		tooltipBit = !("".equals(tooltipBitString) || !"true".equals(tooltipBitString));
	...
	private JFreeChart getChart(JSONObject jsonData, boolean legendBit, boolean tooltipBit) {
