...
public class SusiArgument implements Iterable<SusiThought> {
    ...
    public SusiArgument clone() {
        ...
        this.recall.forEach(c.recall::add);
        this.actions.forEach(c.actions::add);
        return c;
    }
    ...
    public SusiThought mindmeld(boolean reverse) {
        ...
        if (reverse)
            ...
            for (SusiThought aRecall : this.recall) meltedMind.mergeData(aRecall.getData());
     ...
     */
    private SusiThought remember(int timesBack) {
    ...
    public SusiArgument think(SusiArgument argument) {
        argument.recall.forEach(this::think);
        return this;
    }
    ...
    private JSONObject toJSON() {
        ...
        this.recall.forEach(recallJson::put);
