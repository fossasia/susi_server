...
class ChartPlotter extends RasterPlotter {

    private static final int DIMENSION_RIGHT  = 0;
    private static final int DIMENSION_TOP    = 1;
    private static final int DIMENSION_LEFT   = 2;
    private static final int DIMENSION_BOTTOM = 3;
    ...
    private ChartPlotter(final int width, final int height, final Long backgroundColor, final Long foregroundColor, final Long lightColor,
     ...
     */
    private void declareDimension(final int dimensionType, final int scale, final int pixelperscale, final int offset, final Long colorNaming, final Long colorScale, final String name) {
    ...
    private void chartDot(final int dimension_x, final int dimension_y, final float coord_x, final int coord_y, final int dotsize, final String anot, final int anotAngle) {
    ...
    private void chartLine(final int dimension_x, final int dimension_y, final float coord_x1, final int coord_y1, final float coord_x2, final int coord_y2) {
