            ...
            XContentBuilder mapping = XContentFactory.jsonBuilder()
              .startObject()
                .startObject("properties")
                  ...
                  .startObject("location_point").field("type","geo_point").field("include_in_all","false").field("doc_values", true).field("index","not_analyzed").endObject()
                  .startObject("location_radius").field("type","long").field("include_in_all","false").field("doc_values", true).endObject() // unit: kilometer
                  .startObject("location_mark").field("type","geo_point").field("include_in_all","false").field("doc_values", true).field("index","not_analyzed").endObject()
                  .startObject("location_source").field("type","string").field("include_in_all","false").field("index","not_analyzed").field("doc_values", true).endObject()
