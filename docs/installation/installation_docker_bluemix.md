...
11. Upload the susi server docker file to your namespace with `cf ic cpi fossasia/susi_server susi_server`   (takes some time)
...
14. Wait until your container group is build and the network is configured (>1 minute) and
   ...
   ```
15. Send your own bluemix susi server link to Mario in order to prove your done it
